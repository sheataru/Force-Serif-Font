...
<h1>Firefox</h1>
<font color="red">1.</font> Download the source files.
<font color="red">2.</font> Open Firefox and go to about:debugging.
<font color="red">3.</font> Click on "This Firefox" in the left sidebar.
<font color="red">4.</font> Click "Load Temporary Add-on" and select the manifest.json file from the extension folder.
I don't want to upload this to the webstores so this is the best you get. Feel free to do it yourself :)
